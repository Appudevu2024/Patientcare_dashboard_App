...
export default function BloodBankData({ viewOnly = false }) {
  ...
  const filteredBloodbank = bloodbank.filter((bloodgroup) =>
      ...
      {!viewOnly && (
        <div className="mb-4 flex flex-col md:flex-row md:justify-between md:items-center gap-3">
          <div className="flex flex-wrap items-center gap-2">
            <h2 className="text-lg font-semibold">BloodBank</h2>
            {!showForm ? (
              <span
